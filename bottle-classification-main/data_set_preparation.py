...
DATADIR = r"D:\Start-up\ATM\Data"  # Ensure proper formatting

categories = ["glass_bottles", "plastic_bottles", "cans"]
...
pickle_out = open("D:/Start-up/ATM/pickle/x.pickle", "wb")
pickle.dump(X, pickle_out, protocol=4)
pickle_out.close()

# Saving Y list to Y.pickle
pickle_out = open("D:/Start-up/ATM/pickle/y.pickle", "wb")
